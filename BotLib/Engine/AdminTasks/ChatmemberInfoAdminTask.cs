...
namespace BotLib.Engine.AdminTasks
{
    ...
    {
        public ChatmemberInfoAdminTask(long ChatId, long UserId) : base(ChatId, AdminTaskType.ChatmemberInfo)
        {
            this.UserId = UserId;
        }

        public ChatmemberInfoAdminTask(long ChatId, long UserId, DateTime DelayUntil) : base(ChatId, AdminTaskType.ChatmemberInfo, DelayUntil)
        {
            this.UserId = UserId;
        }
